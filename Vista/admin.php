  ...
  <div class="container py-4 d-flex flex-column" style="max-width:500px">
    ...
    <div class="card p-4">
      ...
      <div class="text-center mt-2">
        <a href="<?= BASE_URL ?>/Vista/songs.php" id="catalog-link" class="small" style="color:var(--accent)">🎵 Catálogo de canciones</a>
      </div>
  ...
  <div class="admin-grid">
    ...
    <div class="col-main">
      ...
      <div class="round-song-card">
        ...
        <div id="q-meme-img" class="d-none meme-video-wrap" style="width:100%;max-width:640px;margin:.5rem auto"><div id="q-meme-img-player"></div></div>
  ...
  <div class="admin-grid">
    ...
    <div class="col-main">
      ...
      <div class="round-song-card">
        ...
        <div id="r-meme-img" class="d-none meme-video-wrap" style="width:100%;max-width:640px;margin:.5rem auto"><div id="r-meme-img-player"></div></div>
...
<script src="<?= BASE_URL ?>/assets/js/admin.js?v=65"></script>
</body>
</html>
